...
from pyspark.sql.functions import (
    col, count, sum as spark_sum, desc, size, split, trim,
    to_date, explode as spark_explode
)
...
class SummaryMetrics:
    ...
    def get_top_products(self, df_transactions_exploded: DataFrame,
    ...
    def get_top_customers(self, df_transactions: DataFrame,
                         top_n: int = 10) -> DataFrame:
        """
    ...
    def get_peak_days(self, df_transactions: DataFrame,
                     top_n: int = 10) -> DataFrame:
        """
    ...
    def get_top_categories(self, df_transactions_exploded: DataFrame,
        ...
        df_with_category = (
            df_transactions_exploded
            .join(df_product_categories, "product_id", "left")
    ...
    def generate_executive_summary(self,
                                   ...
                                   df_product_categories: DataFrame,
                                   df_categories: DataFrame) -> Dict[str, Any]:
        """
